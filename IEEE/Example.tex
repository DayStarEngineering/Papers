...
\documentclass[twocolumn,letterpaper]{IEEEAerospace2012}  % only supports two-column, letterpaper format
...
\begin{document}
\title{An Example of the 2012 IEEE Aerospace Conference Paper Format Using a \LaTeX~Enivronment}
...
\begin{abstract}
This paper serves as an example for the use of the \LaTeX~class file for the 2012 Aerospace Conference. The \LaTeX~class file for the 2012 conference has been modified from that of prior year conferences in order to fix minor bugs and to conform to new formatting requirements. Within the class file there are some customized commands that are illustrated in this paper. They are: tableofcontents, acknowledgments, thebiography. There are also comments sprinkled throughout the~.tex file to illustrate the usage of the class file. If you have difficulties or errors using this class file, please contact me at the e-mail address in the author's information slot. Some of the content below is filler designed to show you how a properly formatted paper should look. Read the official ``Author's Instructions for the 2012 IEEE Aerospace Conference'' to find the full description of the paper formatting requirements.
\end{abstract}
...
\begin{itemize}
  ...
  \item [(2)] For papers in which all authors are employees of a Crown Government (UK, Canada, Australia), the notice is: \\{\bf 978-1-4577-0557-1/12/\$26.00 \copyright2012 Crown} \\
  \item [(3)] For all other papers the notice is: \\{\bf 978-1-4577-0557-1/12/\$26.00 \copyright2012 IEEE}
\end{itemize}
...
\hline\hline
Abstracts Due               & July 17, 2011 \\
Review Paper {\bf Deadline} & November 3, 2011 \\
Revised papers Due          & January 4, 2012 \\
IEEE Copyright Form Due     & January 4, 2012 \\
\hline
\end{tabular}
\end{table}
...
\section{Summary}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This Author’s Instructions document serves as a template for papers prepared for the 2012 IEEE Aerospace Conference. All paper submissions are accomplished online, through the IEEE Aerospace Conference website at www.aeroconf.org \cite{AeroConf}
...
{Wayne Blanding}{\rootdir Nick.jpg}
...
{Wayne Blanding}{Blanding.eps}
received his B.S. degree in Systems Engineering from the U.S. Naval Academy in 1982 and an Ocean Engineer degree from the MIT/Woods Hole Joint Program in Ocean Engineering in 1990, and a Ph.D. in Electrical Engineering from the University of Connecticut in 2007.  From 1982 to 2002 was an officer in the U.S. Navy's submarine force and was assigned to three different submarines throughout his career. He retired from the Navy at the rank of Commander. He is currently an Assistant Professor of Electrical and Computer Engineering at York College of Pennsylvania where he is involved in starting up its ECE program. His research interests include target tracking, detection/estimation theory, and sailing. \end{biographywithpic}
