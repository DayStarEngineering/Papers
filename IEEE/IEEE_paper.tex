...
\begin{figure}[H]
    \centering	
    \includegraphics[width=3.3in]{\rootdir YawTracking.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3.3in]{\rootdir PitchTracking.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3.3in]{\rootdir RollTracking.png}
