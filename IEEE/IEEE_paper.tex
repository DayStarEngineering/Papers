...
The current standard for balloon-based attitude determination is the University of Wisconsin's Star Tracker 5000 (ST5000). With roots in NASA's sounding rocket program, this instrument was test flown on May 6, 2011 and performed at $0.24''$ and $0.53''$ ($1\sigma$) pitch and yaw accuracies during nighttime. Unfortunately, the ST5000 saturated 30 minutes before sunrise and was unable to provide an attitude signal during the day. The diffraction limit of a 1-m telescope is $0.125''$ at $5000 \AA{}$. In order to control a fine steering mirror at this level, an error signal must be provided that is at least as good. While the ST5000 is close, it is still a factor of 5 too coarse to be the sole optical reference.
