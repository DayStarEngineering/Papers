...
\begin{figure}
    \centering
    \includegraphics[width=3.3in]{\rootdir starfield.eps}
...
\begin{figure}[H]
    \includegraphics[width=3.3 in]{\rootdir olympus.jpg}
