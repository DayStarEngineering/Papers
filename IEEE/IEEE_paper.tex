...
\begin{figure}
    \includegraphics[width=2.5in]{\rootdir yaw_1.5Hz_freq.png}
    \caption{Yaw Signal and Filtering Using FFT.}
    \label{fig:Yaw Filtering}
\end{figure}

\begin{figure}
    \includegraphics[width=2.5in]{\rootdir pitch_1.5Hz_freq.png}
    \caption{Pitch Signal and Filtering Using FFT.}
    \label{fig:Pitch Filtering}
\end{figure}

\begin{figure}
    \includegraphics[width=2.5in]{\rootdir roll_1.5Hz_freq.png}
